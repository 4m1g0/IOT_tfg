...
public:
  ...
  static const int schedule_interval = 1 * 60 * 1000; // 2m
  static const int pricingUpdate_interval = 5 * 60 * 1000; // 5m
  static const int heartbeat_interval = 1 * 60; //1m
  static const int firmwareUpdate_interval = 3 * 60 * 60 * 1000; // 15m
  static const int reset_interval = 6 * 60 * 60 * 1000; // 6h
  static const int time_ofset = 1 * 60 * 60; // 1h (GTM+1)
